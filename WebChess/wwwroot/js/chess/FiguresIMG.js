...
export function drawBishop(cellElement, figureColor) {
...
export function drawPawn(cellElement, figureColor) {
    let draw = SVG(cellElement);
    switch (figureColor) {
        case FigureColor.black:
...
export function drawRook(cellElement, figureColor) {
    let draw = SVG(cellElement);
    switch (figureColor) {
        case FigureColor.black: {
...
export function drawHorse(cellElement, figureColor) {
    let draw = SVG(cellElement);
    switch (figureColor) {
        case FigureColor.black: {
...
export function drawQueen(cellElement, figureColor) {
    let draw = SVG(cellElement);
    switch (figureColor) {
        case FigureColor.black: {
            draw.style('opacity:1; fill:000000; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;');
        ...
        case FigureColor.white: {
            ...
            p.style("fill:none;");            break;
        }
    }
    return draw.node.id;
}

export function drawKing(cellElement, figureColor) {
    let draw = SVG(cellElement);
    switch (figureColor) {
        case FigureColor.black: {
